...
int main(int argc, char* argv[]){
	...
	while(true){
		...
		cout << "[1]  Text to Speech \n";
		cout << "[2]  Dialog Behavior \n";
		cout << "[3]  Story Telling  \n";
		cout << "[4]  Movement Control  \n";
		cout << "[5]  Head Movement Control  \n";
		cout << "[6]  Mirroring behavior  \n";
		cout << "[7]  Record and Play Audio  \n";
		cout << "[8]  change body posture  \n";
		cout << "[9]  -  \n";
		cout << "[10] exit  \n";
...
void move(){
	...
	AL::ALValue joints_byHumans    = AL::ALValue::array("LShoulderRoll");
	...
	motion.moveInit();
	char c; float x, y, rotation;
	while(true){
		cout << "Enter (m) to move, (s) to stop " << endl;

		cin >> c;
         if(c == 'm'){
        		cout << "Enter the distance in x,y,rotation:" << endl;
        		cin>>x >> y >> rotation;
...
void mirroringBehavior(){
	...
	AL::ALValue  joints_byRobot = AL::ALValue::array("RShoulderPitch","RShoulderRoll","RElbowYaw","RElbowRoll");
	AL::ALValue joints_byHumans    = AL::ALValue::array("LShoulderPitch","LShoulderRoll","LElbowYaw","LElbowRoll");
...
void moveHead(){
	  ...
	  try {
	    ...
	    int x;
	    while(true){
	    	cout << "Enter 1 to move Head Yaw, 2 to move head pitch and 3 to stop behavior" << endl;
	    	cin >> x;
	    	if(x ==1 )
...
void changePosture(){
	...
	string postStr;
	cout << "Enter Posture Name (Sit,Stand)" << endl;
	cin >> postStr;
